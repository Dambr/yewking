...
<!-- 
Что является целью работы?
Ключевые слова: разрабатываемое решение предназначено для поддержки принятия решений по разделению систем на плагины

Глобально: мы делаем разработку системы принятия решений. после этого апробируем ее на решении с открытым исходным кодом
