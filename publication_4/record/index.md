...
<!-- Переработать введение и совместить его с разделом Обзор литературы -->

## Введение

<!-- example:

В последние годы проблема применения теоретических методов оптимизации в практических задачах приобрела значительную актуальность. Многие исследователи сосредоточены на разработке новых алгоритмов, способных эффективно решать сложные задачи с высокой размерностью и ограничениями. Например, в работе [1] предложен метод градиентного спуска с адаптивной стратегией выбора шага, что позволило повысить скорость сходимости при решении задач машинного обучения. Аналогичные подходы представлены в [2], где использовались эволюционные алгоритмы для оптимизации параметров сложных систем.

Особое внимание уделяется применению методов оптимизации к реальным проектам с открытым исходным кодом. В работе [3] авторы демонстрируют успешное использование генетических алгоритмов для настройки параметров программных систем, что подтверждает практическую ценность теоретических разработок. Однако большинство исследований фокусируются на теоретической эффективности или на ограниченных примерах, не всегда учитывая особенности реальных программных проектов.

В контексте данной работы важным является исследование [4], где авторы анализируют возможности применения методов глобальной оптимизации для автоматической настройки конфигураций программных систем. В отличие от предыдущих работ, в нашей статье мы демонстрируем практическую реализуемость предложенных теоретических результатов на конкретном проекте с открытым исходным кодом, что позволяет оценить их эффективность в реальных условиях эксплуатации.

Таким образом, существующие исследования подтверждают перспективность использования современных методов оптимизации для решения прикладных задач, однако их практическая реализация зачастую остается недостаточно изученной. Настоящая работа заполняет этот пробел, показывая эффективность теоретических результатов на конкретном примере реального проекта.

 -->

<!-- В настоящее время программные решения, выполненные и поставляемые как один или компекс плагинов, являются популярными, а их разработка, исследование особенностей построения и способа поставки - актуальные проблемы в области информационных технологий. Отчасти актуальность может быть объснена тем, что такие решения широко востребованы в инструментах разработки и многие среды разработки целенаправленно разрабатываются с заделом на расширение своего собственного функционала благодаря расширениям (плагинам), разработкой которых занимается заинтересованное в этом сообщество разработчкиов, тестировщиков, аналитиков и т.д.
...
В работе продемонстрирована пригодность применения теоретических результатов из работы [1] на примере проекта с открытым исходным кодом, а так же представлено использование генетического алгоритма и RL как альтернативы математической формализации и последующего применения программных решателей.
