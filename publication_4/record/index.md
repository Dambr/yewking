...
Не менее актуален вопрос метрик. Так, в работах [] в качестве метрики эффейтивности разделения функционала приведено... В настоящей работе в качестве такой оценки использовано количество реализованных в комплектации требований: чем ближе эта величина к числу полезных в комплектации требований, тем меньше в комплектации реализовано бесполезных.
