...
Однако выполнять декомпозицию можно не только со стороны сложности предметной области, а и исходя из числа доступных аппаратных мощностей, на которых предстоит выполнять работу будующим микросервисам. В работах [5], [6] и [7] рассматривается именно производительный аспект и сравненивается с показателями решения на монолитной архитектуре. Критериями сравнения является время работы приложений, трудозатраты на развертывание и сопровождение.
