...
Описываемые в работах [*про генетические алгоритмы*] варианты генетических алгоритмов обладают достаточной точностью, независимостью от данных, 
...
<!-- Здесь какую генетику -->

<!-- Здесь какой RL -->

<!-- Описание функции адаптации (в том числе можно сравнить два подхода: бинарный и дискретный) -->
