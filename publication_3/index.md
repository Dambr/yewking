...
Программная реализация для решения оптимизационной задачи выполнена на языке программирования Python. Для ее математической формализации и построения задачи линейного программирования использовался модуль Pyomo. Для реализации генетического алгоритма использовался модуль Pygad.
