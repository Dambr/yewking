...
| тип родительского выбора | steady-state selection | roulette wheel selection | or stochastic universal selection |
| число сохраняемых родительских решений | 10 | 1 | 0 |
...
Скачкообразность графиков объясняется различными значениями сгенерированных матриц, занулением коэффициентов и способностью MILP-решателя выполнять оптимизацию выражений. На графиках соответствующих работе генетических алгоритмов интенсивная скачкообразность не наблюдается.
