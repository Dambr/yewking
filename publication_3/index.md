...
Анализ операторов генетического алгоритма не показал лучший вариант для применения. Поэтому была выполнены реализации генетического алгоритма, включающие следующие опереаторы:

| № | кол-во поколений | кроссовер | размер популяции | количесвто скрещиваемых особей | мутация |
|:-:|:-:|:-:|:-:|:-:|:-:|
| 1 |   |   |   |   |   |
| 2 |   |   |   |   |   |
| 3 |   |   |   |   |   |
