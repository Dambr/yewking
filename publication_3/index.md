...
$$\sum^{n}_{i = 1} (\dot{r}_{\tilde{l}, i} \cdot (с_{i, 1} \cdot \dot{r}_{\tilde{l}, 1} + с_{i, 2} \cdot \dot{r}_{\tilde{l}, 2} + ... + с_{i, n} \cdot \dot{r}_{\tilde{l}, n})) = \dot{R}_{\tilde{l}}^{T} \cdot C \cdot \dot{R_{\tilde{l}}}$$

Суммарная стоимость всех требований во всех комплектациях:

$$\sum (\dot{R}^{T} \cdot C \cdot \dot{R})$$
...
<!-- Про линелиаризацию и построение задачи линейного программирования -->
### Задача линейного программирования

Оптимизационная задача может быть решена как задача линейного программирования.
