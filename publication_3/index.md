...
После разрешения зависимостей на всех уровнях для получения вектора файлов, которые необходимо поставить достаточно просуммировать вектор полезных файлов и каждый из векторов разрешения зависимостей.
