...
class VarTable:
    def __init__(self):
        ...
        data = {
            'G0' : [         3,          3,          1,          1,          2,         10,          2,         10],
            'G1' : [         3,          3,          1,          2,         10,        100,         10,         20],
            'G2' : [         3,          3,          1,          3,        100,        300,         20,         30],
            'G3' : [         3,          3,          1,          4,        300,        500,         30,         50],
            'G4' : [         3,          3,          2,          5,        500,        800,         50,         80],
            'G5' : [         3,          3,          3,          6,        800,       1000,         80,        100],
            'G6' : [         3,          3,          4,          7,       1000,       3000,        100,        300],
            'G7' : [         3,          3,          5,          8,       3000,       5000,        300,        500],
            'G8' : [         3,          3,          6,          9,       5000,       8000,        500,        800],
            'G9' : [         3,          3,          7,         10,       8000,      10000,        800,       1000]
        }
        self.df = pd.DataFrame.from_dict(data, orient='index', columns=columns)

    def get_nested_directory(self, experiment_number, experiment_subnumber):
        nested_directory = 'experiments/{}/{}'.format(experiment_number, experiment_subnumber)
